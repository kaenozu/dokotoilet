// 自動生成: bun scripts/manual-import/run.ts --in shibuya-01.json --in kumagaya-manual-01.json --in kumagaya-02.json --in reevaluate-osm-seed-01.json --in reevaluate-od-batch1.json
// 生成日: 2026-09-10
